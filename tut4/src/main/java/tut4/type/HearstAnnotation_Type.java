...
public class HearstAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("tut4.type.HearstAnnotation");
  ...
  public String getHyponym(int addr) {
      ...
      jcas.throwFeatMissing("Hyponym", "tut4.type.HearstAnnotation");
  ...
  public String getHyperonym(int addr) {
      ...
      jcas.throwFeatMissing("Hyperonym", "tut4.type.HearstAnnotation");
  ...
  public String getTypeOf(int addr) {
      ...
      jcas.throwFeatMissing("TypeOf", "tut4.type.HearstAnnotation");
