...
import de.unihamburg.informatik.nlp4web.tutorial.tut5.type.NewsAnnotation;
...
public class NewsClassificationAnnotator extends CleartkAnnotator<String> {
    ...
    private TfidfExtractor<String, NewsAnnotation> initTfIdfExtractor() throws IOException {
        ...
        TfidfExtractor<String, NewsAnnotation> tfIdfExtractor = new TfidfExtractor<String, NewsAnnotation>(
                NewsClassificationAnnotator.TFIDF_EXTRACTOR_KEY,
                countsExtractor);
    ...
    private CentroidTfidfSimilarityExtractor<String, NewsAnnotation> initCentroidTfIdfSimilarityExtractor()
        ...
        CentroidTfidfSimilarityExtractor<String, NewsAnnotation> simExtractor = new CentroidTfidfSimilarityExtractor<String, NewsAnnotation>(
                NewsClassificationAnnotator.CENTROID_TFIDF_SIM_EXTRACTOR_KEY,
                countsExtractor);
    ...
    public void collectFeatures(File outputDirectory) throws IOException, CleartkProcessingException {
        ...
        URI tfIdfDataURI = NewsClassificationAnnotator.createTokenTfIdfDataURI(outputDirectory);
        ...
        URI tfIdfCentroidSimDataURI = NewsClassificationAnnotator.createIdfCentroidSimilarityDataURI(outputDirectory);
        CentroidTfidfSimilarityExtractor<String, NewsAnnotation> simExtractor = new CentroidTfidfSimilarityExtractor<String, NewsAnnotation>(
                NewsClassificationAnnotator.CENTROID_TFIDF_SIM_EXTRACTOR_KEY);
        ...
        URI minmaxDataURI = NewsClassificationAnnotator.createMinMaxDataURI(outputDirectory);
        MinMaxNormalizationExtractor<String, NewsAnnotation> minmaxExtractor = new MinMaxNormalizationExtractor<String, NewsAnnotation>(
                NewsClassificationAnnotator.MINMAX_EXTRACTOR_KEY);
